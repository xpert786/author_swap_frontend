          ...
          <div className="bg-white rounded-[18px] shadow-2xl w-full p-6 md:p-10">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              ...
              <div className="flex justify-between items-center py-0.5">
                <label className="flex items-center gap-2 cursor-pointer group">
                  ...
                  />
                  <span className="text-xs font-medium text-gray-500 group-hover:text-gray-800 transition-colors">Remember me</span>
                </label>
                <Link
                  to="/forget-password"
                  className="text-[11px] font-semibold text-[#2F6F6D] hover:underline"
                >
              ...
              <button
                type="submit"
                className="w-full bg-[#E07A5F] text-white py-3 rounded-xl hover:bg-[#d96b57] font-bold text-sm transition-all shadow-lg active:scale-[0.98] mt-1"
              >
                Log In
              </button>
            </form>
            ...
            <div className="flex flex-col items-center mt-6">
              <p className="text-xs font-semibold text-gray-500">
                ...
                <Link
                  to="/signup"
                  className="text-[#2F6F6D] font-bold hover:underline"
                >
                  Sign up
                </Link>
              </p>
