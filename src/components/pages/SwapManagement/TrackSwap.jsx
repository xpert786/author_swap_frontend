            ...
            <div className="bg-white border border-[#B5B5B5] rounded-[8px] p-4 mb-6">
                ...
                >
                    ...
                    <span className="text-lg font-medium">
                        {(data.status === "completed" || data.status === "complete") ? "Swap Completed" : data.status_label || (data.status ? data.status.charAt(0).toUpperCase() + data.status.slice(1) : "In Progress")}
                    </span>
                </div>
            </div>
