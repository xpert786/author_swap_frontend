        ...
        <div className="min-h-screen">
            ...
            <div className="bg-white border border-[#B5B5B5] rounded-[8px] p-4 mb-6">
                <div className="flex items-center gap-4 pb-2 border-b border-[#2F6F6D33]">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-[#374151] fonr-medium">{data.author_role || data.role || "Author"}</p>
                    </div>
                </div>
                ...
                <div className="pt-2">
                    <div className="flex gap-16">
                        <div>
                            ...
                            <p className="text-base font-medium text-[#111827]">{data.request_date || data.requestDate || "N/A"}</p>
                        </div>
                        <div>
                            <p className="text-xs text-[#374151] font-medium mb-1.5">Compete Date</p>
                            <p className="text-base font-medium text-[#111827]">{data.completed_date || data.completedDate || "N/A"}</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="bg-white border border-[#B5B5B5] rounded-[8px] p-4 mb-6">
                ...
                >
                    ...
                    <span className="text-lg font-medium">{data.status === "completed" ? "Swap Competed" : data.status || "Swap Tracked"}</span>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-1 gap-6 mb-6">
                {/* Links Container */}
                <div className="bg-white border border-[rgba(181,181,181,1)] rounded-[8px] p-4">
                    ...
                    <div className="space-y-4">
                        {(data.links || [
                            ...
                            <div key={idx} className="flex text-sm mb-3">
                                ...
                                <span className="font-normal text-[#374151]]">{link.value}</span>
                            </div>
                        ))}
                    </div>
                </div>
                    ...
                    <div className="flex gap-6">
                        ...
                        <div className="flex-1">
                            ...
                            <div className="flex justify-between items-center">
                                ...
                                <span className="bg-[#E8E8E8] text-black text-[11px] px-3.5 py-1 rounded-full font-medium shrink-0">
                                    Upcoming
                                </span>
                            </div>
                        </div>
                    ...
                    <table className="w-full bg-white border-separate border-spacing-0">
                        <thead>
                            <tr style={{ background: "rgba(47, 111, 109, 0.1)" }}>
                                <th className="p-4 text-left text-[11px] font-medium text-[#111827] border-t border-b border-[#B5B5B5]">Link / Destination</th>
                                <th className="p-4 text-left text-[11px] font-medium text-[#111827] border-t border-b border-[#B5B5B5]">Clicks</th>
                                <th className="p-4 text-left text-[11px] font-medium text-[#111827] border-t border-b border-[#B5B5B5]">CTR</th>
                                <th className="p-4 text-left text-[11px] font-medium text-[#111827] border-t border-b border-[#B5B5B5]">Conversion</th>
                            </tr>
                        </thead>
                        <tbody className="">
                            {(data.ctr_analysis || [
                                ...
                                <tr key={idx} className="">
                                    ...
                                    <td className="p-4 border-b border-[#B5B5B5]">
                                        ...
                                        <p className="text-[10px] font-medium text-[rgba(22,163,74,1)]">
                                            {row.ctrStatus}
                                        </p>    
                                    </td>
