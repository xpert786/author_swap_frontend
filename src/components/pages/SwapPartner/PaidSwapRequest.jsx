...
const PaidSwapRequest = ({ isOpen, onClose, id, price }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            toast.success("Paid swap request sent successfully!");
            onClose();
        } catch (error) {
        ...
        <div className="fixed inset-0 z-[1000] flex items-center justify-center bg-black/40 p-4">
            <div className="bg-white w-[600px] rounded-[10px] shadow-xl overflow-hidden m-5">
                <div className="p-6 max-h-[90vh] overflow-y-auto custom-scrollbar relative">
                    ...
                    <div className="flex justify-between items-center mb-4 bg-[#2F6F6D]/5 p-4 rounded-xl border border-[#2F6F6D]/10">
                        <div className="flex items-center gap-3">
                            <div className="w-10 h-10 bg-[#2F6F6D] rounded-full flex items-center justify-center text-white font-bold">
                                $
                            </div>
                            <div>
                                <p className="text-[12px] font-medium text-[#2F6F6D] uppercase tracking-wider">Author's Price</p>
                                <p className="text-xl font-bold text-black">${parseFloat(price || 0).toFixed(2)}</p>
                            </div>
                        </div>
                        <button
                            type="button"
                    ...
                    {slotInfo?.formattedDateTime && (
                        <div className="flex items-center gap-3 mb-4 px-4 py-3 bg-gradient-to-r from-[#2F6F6D0D] to-[#2F6F6D05] border border-[#2F6F6D30] rounded-xl">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="flex justify-end gap-3 pt-4 border-t border-gray-100">
                            ...
                            >
                                ...
                                {submitting ? "Sending..." : "Send Paid Request"}
                            </button>
                        </div>
                    </form>
                </div>
...
export default PaidSwapRequest;
